    ...
    <>
      <main className="max-w-4xl mx-auto px-6 py-8">
        <div className='space-y-5'>
          {watchedValues.featuredImage ? (<div className="relative group">
              <img
          ...
          className='w-full h-36 border-2 border-dashed border-slate-600 rounded-xl flex flex-col items-center justify-center space-y-4 hover:border-slate-500 transition-colors group'>
            ...
            <div className='text-center'>
              <p className='text-slate-300 text-lg font-medium'>Add a featured image</p>
              <p className='text-slate-500 text-sm mt-1'>Upload and transform with AI</p>
            </div>
          </button>)}
          ...
          <div>
            ...
            >
              <Wand2 className='h-4 w-4 mr-2'/>
                Generate with AI
            </Button> :(<div className="grid grid-cols-3 w-full gap-2">
                {[
