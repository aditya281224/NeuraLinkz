...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      <div className="fixed inset-0 bg-gradient-to-r from-orange-300/20 via-pink-400/20 to-purple-400/20 animate-pulse">
        <div
          className="fixed w-96 h-96 bg-gradient-to-r from-green-300/20 via-emerald-400/20 to-teal-500/20 rounded-full blur-3xl pointer-events-none z-0"
          style={{
          ...
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
            <div className="space-y-4 sm:space-y-6">
              <h1 className="text-7xl lg:text-8xl font-black leading-none tracking-tight">
                <span className="block font-black text-white">Ideate</span>
                <span className="block font-light text-purple-300">
                  Execute
                </span>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto px-4">
              Whether it’s AI-driven writing or powerful analytics, NeuraLinkz
              offers everything modern creators need in one place.
            </p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-8">
      ...
      <section className="relative z-10 py-16 sm:py-24 px-4 sm:px-6">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:ext-6xl font-black mb-4 sm:mb-6">
            How it works
          </h2>
          <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto px-4">
            A trio of powerful tools working in sync to amplify your creative
            process..
          </p>
        </div>
  ...
  <div className="max-w-4xl mx-auto text-center">
    <h2 className="text-4xl sm:text-5xl md:text-6xl font-black mb-6 sm:mb-8">
      <span className="gradient-text-primary">Ready to begin?</span>
    </h2>
    <p className="text-xl text-gray-400 mb-8 sm:mb-12 max-w-2xl mx-auto">
      Be part of a growing community of creators who are scaling their reach
      and building successful brands with the power of AI.
    </p>
